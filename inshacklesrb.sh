C #!/bin/bash
# Inshackle v1.0
# recoded by: guccimanezz
# github.com/thej0hnnywalk3r/inshacklesrb
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by guccimanezz\e[0m\n"
}
...
read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Korisniko ime: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Kolacici pronadjeni za korisnika\e[0m\e[1;77m %s\e[0m\n" $user

default_use_cookie="Y"

read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Zelis li iskoristiti?\e[0m\e[1;77m [Y/n]\e[0m ' use_cookie

use_cookie="${use_cookie:-${default_use_cookie}}"

if [[ $use_cookie == *'Y'* || $use_cookie == *'y'* ]]; then
printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Koriscenje sacuvanih akreditiva\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Pokusavam da se prijavim kao\e[0m\e[1;93m %s\e[0m\n" $user
IFS=$'\n'
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Generisanje liste slika\n"
...
count_img=0
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Ukupno slika:\e[0m\e[1;93m %s\e[0m \n" $tot_img

for img in $(cat links); do

let count_img++
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Preuzimanje slike\e[0m\e[1;93m %s/%s\e[0m " $count_img $tot_img
wget $img -O $user/images/image$count_img.jpg > /dev/null 2>&1
printf "\e[1;92mGotovo!\n\e[0m"
done
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Sacuvano:\e[0m\e[1;93m %s/images/\e[0m\n" $user
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Ukupno videa:\e[0m\e[1;93m %s\e[0m\n" $tot_vid
for link in $(cat vid_$user); do
let count++
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Preuzimanje videa\e[0m\e[1;93m %s/%s\e[0m " $count $tot_vid
printf "\e[1;92mGotovo!\n\e[0m"
wget $link -O $user/videos/video$count.mp4 > /dev/null 2>&1
done

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Sacuvano:\e[0m\e[1;93m %s/videos/\e[0m\n" $user 
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kreiranje liste pratioca za korisnika\e[0m \e[1;77m%s\e[0m\n" $user_account
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Molimo sacekajte...\e[0m\n"
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Ukupno videa sa storija:\e[0m\e[1;93m %s\e[0m\n" $tot_vid
IFS=$'\n'
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Preuzimanje videa sa price\e[0m\e[1;93m %s/%s\e[0m " $count $tot_vid
printf "\e[1;92mGotovo!\n\e[0m"
IFS=$'\n'
wget $link -O $user_account/story/story$count.mp4 > /dev/null 2>&1
done

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Sacuvano:\e[0m\e[1;93m %s/story/\e[0m\n" $user_account

#Story Image
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Ukupno slika sa storija:\e[0m\e[1;93m %s\e[0m\n" $tot_img

for link2 in $(cat $user_account.story_images); do
let count2++

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Preuzimanje slike sa price\e[0m\e[1;93m %s/%s\e[0m " $count2 $tot_img
printf "\e[1;92mGotovo!\n\e[0m"
IFS=$'\n'
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Pripremanje za odpracivanje svih pratioca sa \e[0m\e[1;77m%s ...\e[0m\n" $user_account
...
if [[ $check_unfollow == "" ]]; then
printf "\n\e[1;93m [!] Doslo je do greske\e[0m\n"
exit 1
else
printf "\e[1;92mOK\e[0m\n"
fi
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Ova tehnika je zapracivanje i odpracivanje..\e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Mozete povecati pratioce za cak +30 u 1 satu \e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m]\e[0m\e[1;93m Pritisni Ctrl + C da zaustavis \e[0m\n"
sleep 5
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Pokusavam da zapratim celebgram %s ..." $celeb
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m Pauza 60 sekundi...\e[0m\n"
sleep 60
#unfollow
for celeb in $(cat celeb_id); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Pokusavam da odpratim celebgram %s ..." $celeb
check_unfollow=$(curl -s -L -b cookie.$user -d "ig_sig_key_version=4&signed_body=$hmac.$data" -s --user-agent 'User-Agent: "Instagram 10.26.0 Android (18/4.3; 320dpi; 720x1280; Xiaomi; HM 1SW; armani; qcom; en_US)"' -w "\n%{http_code}\n" -H "$header" "https://i.instagram.com/api/v1/friendships/destroy/$celeb/" | grep -o '"following": false' ) 

if [[ $check_unfollow == "" ]]; then
printf "\n\e[1;93m [!] Doslo je do greske\n"
exit 1
else
printf "\e[1;92mOK\e[0m\n"
fi
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Odpraceni:\e[0m\n"

grep -Fxv -f followers2.$user_account followers1.$user_account >> $user_account.unfollowers
printf "\e[1;77m\n"
cat $user_account.unfollowers
printf "\e[0m\n"
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Sacuvano: \e[0m\e[1;77m%s.unfollowers\e[0m\n" $user_account
mv followers2.$user_account followers1.$user_account

else
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Nema Odpracenih\e[0m\n"
fi


else
#get  followers
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kreiranje liste pratioca u toku..\e[0m\n"
total_followers
cp $user_account.followers_backup followers1.$user_account
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Sacuvano!\e[0m\e[1;77m (followers1.%s)\e[0m\n" $user_account
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Molimo, pokrenite ponovo za automatsko odpracivanje\e[0m\n"
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Preuzimanje profilne slike...\e[0m"
count=0
...
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m01\e[0m\e[1;31m]\e[0m\e[1;93m Automatsko Odpracivanje Zapracenih\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m02\e[0m\e[1;31m]\e[0m\e[1;93m Povecaj Pratioce\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m03\e[0m\e[1;31m]\e[0m\e[1;93m Preuzmi Price\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m04\e[0m\e[1;31m]\e[0m\e[1;93m Preuzmi Sacuvan Kontent\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m05\e[0m\e[1;31m]\e[0m\e[1;93m Preuzmi Listu Pracenja\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m06\e[0m\e[1;31m]\e[0m\e[1;93m Preuzmi Listu Pratioca\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m07\e[0m\e[1;31m]\e[0m\e[1;93m Preuzmi Informacije Profila\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m08\e[0m\e[1;31m]\e[0m\e[1;93m Aktiviraj Odpracivanje\e[0m\n"
printf "\n"


read -p $' \e[1;31m[\e[0m\e[1;77m::\e[0m\e[1;31m]\e[0m\e[1;77m Izaberi opciju: \e[0m' option
...
printf "\e[1;93m[!] Opcija koju ste izabrali nije validna!\e[0m\n"
sleep 2
menu
